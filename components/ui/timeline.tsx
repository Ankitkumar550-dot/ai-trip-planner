    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Your Trip Itinerary from <strong className="text-red-500 dark:text-red-500">{tripData?.origin}</strong> to <strong className="text-red-500 dark:text-red-500">{tripData?.destination}</strong> is Ready
        </h2>
